...
export class GenerationService {
  ...
  addDummyData(data: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/add-dummy-data`, data, {
      headers: new HttpHeaders({
        'Content-Type': 'application/json'
      })
    });
  ...
  getUMLData(): Observable<any> {
    return this.http.get<any>(`${this.baseUrl}/get-dummy-data`);
  }
}
